...
#ifndef ADS1248_REG_H_
#define ADS1248_REG_H_
...
st_reg ADS1248_regs[] =  //AD7172-2 INIT 20161102
{
 ...
 ////////////중요/////////////////////////////////////////////////
    ...
    {0x0A, 0x0004, 2}, // IDAC0
    {0x0B, 0x0089, 2}, // IDAC1
    {0x0C, 0x0000, 2}, // GPIOCFG
    {0x0D, 0x0000, 2}, // GPIODIR
    {0x0E, 0x0000, 2}, // GPIODAT
    {0xFF, 0x0000, 2}  // ADIS16467_REG_NO
 //-------------------------------------------------------------------------------

};

//extern st_reg ADS1248_regs[];

//#define COMM_REG_WR     (0x011 << 13)
//#define COMM_REG_RD     (0x101 << 12)

//#define COMM_REG_WR     (0x6000)
//#define COMM_REG_RD     0 //(0xA000)


#define RDATA                               ((uint16_t) 0x0012)
#define RDATAC                              ((uint16_t) 0x0014)
#define SDATAC                              ((uint16_t) 0x0016)
#define RREG                                ((uint16_t) 0x0020)
#define WREG                                ((uint16_t) 0x0040)
#define SYSOCAL                             ((uint16_t) 0x0060)
#define SYSGCAL                             ((uint16_t) 0x0061)
#define SELFOCAL                            ((uint16_t) 0x0062)



#define CHANNEL_COUNT (4)   // ADS1248M04 -> 4 Channels

#if ((CHANNEL_COUNT < 1) || (CHANNEL_COUNT > 8))
    #error Invalid channel count configured in 'ADS1248m0x.h'.
#endif
 ...
 *  NOTE 2: Bits 0 through 4 are RESERVED on the ADS1248M04. These bits will always read 0.
 */
 ...
 * -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 *  NOTE 1: Bits 12 through 15 are RESERVED on the ADS1248M04.
 */
 ...
 * -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 * NOTE 1: This register is RESERVED on the ADS1248M04. Only write 0x0000 to this register.
 */
